...
EXECUTABLES=test-hexfml test-coords test-typesetter test-sexp test-sisenet test-sftools spserver spclient spguient test-hexfml test-hexplorer test-fov test-tacclient test-boxrandom
...
test-tacclient: test-tacclient.o HexFov.o HexTools.o myabort.o TacClient.o sftools.o hexfml.o mtrand.o TacClientAction.o typesetter.o anisprite.o Tac.o Sise.o SProto.o TacRules.o TacClientVisuals.o
	$(CC) $(CPPFLAGS) $(LIBS) $^ -o $@
